...
interface IconProps {
  name: 'regenerate' | 'sparkles' | 'trash' | 'download';
  className?: string;
}
...
const ICONS: Record<IconProps['name'], React.ReactNode> = {
  regenerate: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0M6.812 6.812A8.25 8.25 0 0118.475 6.812" />
    </svg>
  ),
  sparkles: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
